				...
				<div class="card mt-3">
					...
					<div class="card-body">
						<div class="form-group">
							<label for="address-select">Chọn Quận/Huyện</label> <select
								class="form-control" id="district-select" disabled>
								<option value="default" disabled selected><%=districts.getName()%>
								</option>
					...
					<div class="card-footer d-flex justify-content-end">
						<button class="btn btn-outline-secondary px-3" type="button"
							name="back" onclick="history.back()">Chọn lại Quận</button>
					</div>
				</div>
